...
# Extract files
ui_print "- Modding MIUI to let you feel the luv of Google..."
unzip -o "$ZIPFILE" -x 'META-INF/*' 'common/functions.sh' -d $MODPATH >&2
[ -f "$MODPATH/common/addon.tar.xz" ] && tar -xf $MODPATH/common/addon.tar.xz -C $MODPATH/common 2>/dev/null

# Run addons
if [ "$(ls -A $MODPATH/common/addon/*/install.sh 2>/dev/null)" ]; then
  ui_print " "; ui_print "- Add-ons getting ready"
...
# Set permissions
ui_print "- Setting permission to kill..."
...
# Complete install
ui_print "- Be Google with you"
ui_print "-- @jigs4wkiller"
ui_print "--- @einholzstuhl"
ui_print "---- Now you ready to enter the void"
ui_print "----- MIUI replaced by Android"
ui_print "----- P.S. I still love you"
ui_print "------ Don't trust agents"
ui_print "------- MIUI was a inside job"
cleanup
